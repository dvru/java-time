class PaintJob {
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int availableBucket) {
    ...
    public static int getBucketCount(double areaToCover, double areaPerBucket) {
